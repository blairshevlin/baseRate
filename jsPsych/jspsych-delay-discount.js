...
jsPsych.plugins["delay-discount"] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    var start_color = 'rgb(105,105,105)'
    ...
    var display_stage = function () {
      ...
      new_html += '<div class="container-multi-choice-column" id= "multiattribute-choices-stimulus-left" style="position:fixed; TOP:50%; LEFT:25%; transform: translate(-50%, -50%); line-height: 0; border:8px solid gray; width: 125px; height: 250px">';
      new_html += `<div id="multiattribute-choices-stimulus-left"> <p> <br>`+trial.stimulus[0]+`</p> </div>`;
      new_html += '</div>';
      new_html += '<div class="container-multi-choice-column" id= "multiattribute-choices-stimulus-right" style="position:fixed; TOP:50%; LEFT:75%; transform: translate(-50%, -50%); line-height: 0; border:8px solid gray; width: 125px; height: 250px">';
      new_html += `<div id="multiattribute-choices-stimulus-right"> <p> <br>`+trial.stimulus[1]+`</p> </div>`;
      new_html += '</div>';

...
jsPsych.plugins["econ-choice"] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    var selected_color = 'rgb(255,215,0)';
    ...
    var display_stage = function () {
      ...
      new_html += `<div id="multiattribute-choices-stimulus-left" ><img style = "WIDTH:400px; HEIGHT:300px" src="${trial.stimulus[0]}"/></div>`;
      new_html += '</div>';
      ...
      new_html += `<div id="multiattribute-choices-stimulus-right" ><img style = "WIDTH:400px; HEIGHT:300px" src="${trial.stimulus[1]}"/ ></div>`;
      new_html += '</div>';
